...
f_axA.text(USpX+20,2300,"B{0}B'".format(endash),fontweight='extra bold',color='r',fontsize=16)

f_axA.plot(np.ones(2)*LSpX,[1700,2400],'r:')
f_axA.text(LSpX+20,2300,"C{0}C'".format(endash),fontweight='extra bold',color='r',fontsize=16)
...
f_axA.text(xc,yc,'a',fontsize=18,fontweight='extra bold',fontstyle='italic')
...
f_axB.text(20 + US_offset,2300,"A{0}A'".format(endash),fontweight='extra bold',color='r',fontsize=16)
...
f_axB.text(xc,yc,'b',fontsize=18,fontweight='extra bold',fontstyle='italic')
...
f_axC.text(20 + LS_offset,2300,"A{0}A'".format(endash),fontweight='extra bold',color='r',fontsize=16)
...
f_axC.text(xc,yc,'c',fontsize=18,fontweight='extra bold',fontstyle='italic')

plt.show()

if issave:
	OFILE = os.path.join(ODIR,'SG7_Accepted_Fig4_Transects_%ddpi.png'%(DPI))
